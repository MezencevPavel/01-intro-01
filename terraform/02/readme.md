...
**занесён в personal.auto.tfvars**
4. Инициализируйте проект, выполните код. Исправьте намеренно допущенные синтаксические ошибки. Ищите внимательно, посимвольно. Ответьте, в чём заключается их суть.

**Ошибка в коде platform**

**Ошибка в количестве ядер**

5. Ответьте, как в процессе обучения могут пригодиться параметры ```preemptible = true``` и ```core_fraction=5``` в параметрах ВМ. Ответ в документации Yandex Cloud.

**preemptible = true. прерываемые виртуальные машины — это виртуальные машины, которые могут быть принудительно остановлены в любой момент, 1) прошло 24 часа после запуска ВМ 2) при нехватке ресурсов для запуска ВМ в той же зоне доступности**

**core_fraction=5 базовый уровень производительности CPU 5%**
